...
class PHPExcel_Writer_Excel2007 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
	...
	public function save($pFilename = null)
	{
		if ($this->_spreadSheet !== NULL) {
			...
			//@23may//$saveDateReturnType = PHPExcel_Calculation_Functions::getReturnDateType();
			//@23may//PHPExcel_Calculation_Functions::setReturnDateType(PHPExcel_Calculation_Functions::RETURNDATE_EXCEL);
			...
			//@23may//PHPExcel_Calculation_Functions::setReturnDateType($saveDateReturnType);
