...
class ConfigurationsController extends CommonController{
			...
			if(!$frm->validate($post)){
				...
				if ($post["mode"]=="options") {
					$post = array_merge(array(
										...
										'CONF_ENABLE_VIEW_COUNT' => 0, //Added On 21-08-2018
                                        'CONF_ENABLE_VIEW_PARTICULAR_IP' => 0, //Added On 23-08-2018
	...
	case 'options':
        ...
        //Added 21-08-2018
        $fldALA = $frm->addCheckBox('Enable View Count:', 'CONF_ENABLE_VIEW_COUNT', '1', 'CONF_ENABLE_VIEW_COUNT', 'class="field4"', Settings::getSetting("CONF_ENABLE_VIEW_COUNT"));
        $fldALA->html_after_field = '<small>On enabling, sellers will be able to see product views.</small>';

        //Added 23-08-2018
        $fldALA = $frm->addCheckBox('Enable particular IP:', 'CONF_ENABLE_VIEW_PARTICULAR_IP', '1', 'CONF_ENABLE_VIEW_PARTICULAR_IP', 'class="field4"', Settings::getSetting("CONF_ENABLE_VIEW_PARTICULAR_IP"));
        $fldALA->html_after_field = '<small>On enabling, product views only increase for different IP\'s.</small>';
