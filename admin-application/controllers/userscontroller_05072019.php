...
class UsersController extends BackendController {
	...
	function update_seller_cancellation_request_status(){
		...
		if ($mod=='approve'){
				...
				if (in_array($cancellation_request["opr_status"],$arr_pro_com)){	
					$oObj=new Orders();
					$oObj->addChildOrderHistory($cancellation_request["opr_id"],Settings::getSetting("CONF_DEFAULT_CANCEL_ORDER_STATUS"),Utilities::getLabel('M_Your_Cancellation_Request_Approved'),true,"",0,$commission_cancel_reason);
				}else{
					//echo 'here';
					//exit;
					Message::addError('This order is not eligible for cancellation.');
