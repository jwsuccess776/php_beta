    ...
    if (!$records || !is_array($records)) {
        ...
        foreach ($records as $record) {
            ...
            <tr>
                ...
                <td><strong>Bank Name:</strong> <?php echo trim($record["withdrawal_bank"])?><br/><strong>A/c Name</strong>: <?php echo $record['withdrawal_account_holder_name']?><br/><strong>A/c Number</strong>: <?php echo $record['withdrawal_account_number']?><br/><strong>Branch Code</strong>: <?php echo $record['withdrawal_ifc_swift_code']?><br/><strong>Comments/Instructions</strong>: <?php echo $record['withdrawal_comments']?><?php if (strlen($record['withdrawal_cancel_comments'])):?><br/><strong>Reason for cancellation</strong>: <?php echo $record['withdrawal_cancel_comments']?><?php endif;?></td>
