...
//error_reporting(E_ALL);
        ...
        function publications()
        {
            ...
            $psObj->selectFields(array('tp.*', 'ts.shop_id', 'ts.shop_user_id', 'ts.shop_name', 'ts.shop_title', 'tu.user_id', 'tu.user_name', 'tu.user_username', 'tu.user_email', 'IF(prod_stock >0, "1", "0" ) as available,tptv.total_visit'));
