...
<div class="your-cart">
            <div class="head-name"><?php echo Utilities::getLabel('L_Your_Cart')?> <span>(<label class="count_cart_items"><?php echo count($products)?></label> <?php echo Utilities::getLabel('L_items')?>)</span></div>
            ...
            <div class="bag-item">
        	      ...
        	      <?php } ?>
		              ...
		              <input type="number" id="qty<?php echo md5($product['key']); ?>"  name="quantity[<?php echo md5($product['key']); ?>]"
                                     class="form-control qty" value="<?php echo $product['quantity']; ?>" min="<?php echo $product['minimum']?>" 
                                     max="<?php echo $product['product_stock']?>" 
                                     onchange="cart.short_update('<?php echo md5($product['key']); ?>','<?php echo md5($product['key']); ?>');">
	 ...
	 width="70px" height="70px" viewBox="0 0 70 70" enable-background="new 0 0 70 70" xml:space="preserve">
          ...
          <div class="coupons">
            <div class="discount-code fdsfd"> <a href="#" class="btn tgl-triger"><?php echo Utilities::getLabel('M_Have_coupon')?></a>
