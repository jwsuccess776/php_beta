...
<div data-attr-id="{{promotion_id}}" class="{{#prod_promotion_id}}thumb_impression  thumb_click {{/prod_promotion_id}} shop-item {{#prod_out_of_stock}} <?php  echo 'out-of-stock'; ?> {{/prod_out_of_stock}}" itemscope itemtype="http://schema.org/Product" >
                ...
                <div class="image">
                  ...
                  <a itemprop="url" {{prod_image}} class="ppc_promotion_click" href="{{prod_url}}">
                  

                  

                   <img class="img-responsive YES-1" src="{{prod_image}}" alt="{{prod_name}}" onerror="this.src='{{prod_image_url}}'">

 
<!-- 
                <img class="img-responsive" src="{{prod_image_url}}" alt="{{prod_name}}"> -->
