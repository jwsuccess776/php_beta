<div class="shop-item equal_height_shop_item <? if ($row["promotion_id"]>0):?>thumb_impression thumb_click<?php endif;?> " data-attr-id="<?php echo $row["promotion_id"]?>" >
                ...
                <div class="avatar-container">
	                  ...
	                  <div class="avatar">
		                      ...
		                      <a  class="ppc_promotion_click" ref="<?php echo Utilities::generateUrl('shops','view',array($row["shop_id"]))?>">	
				                  ...
				                  <img class="lozad" data-src="<?php echo Utilities::generateUrl('image','shop_logo',array($row["shop_logo"],'THUMB'))?>" alt="<?php echo $row["shop_name"]?>">
              ...
              <div class="item-body">
                ...
                <div class="image">
                  ...
                  <a href="<?php echo Utilities::generateUrl('products','view',array($val["prod_id"]))?>">

                    <!-- <img class="img-respsive" src="<?php echo Utilities::generateUrl('image','product_image',array($val["prod_id"],'MEDIUM'))?>" alt="<?php echo $val["prod_name"];?>" onerror='this.src=""'> -->

                    <img class="img-responsive" src="<?php echo $val["prod_image"]?>" alt="<?php echo $val["prod_name"];?>"
                     onerror='this.src="<?php echo Utilities::generateUrl('image','product_image',array($val["prod_id"],'MEDIUM'))?>"'>
              ...
              <div class="bttm">
                ...
                <ul class="smallthumbs">
                  ...
                  <?php  $inc=0; foreach ($row["products"] as $key=>$val): $inc++; if ($inc>1 && $inc<5): ?>
                  	...
                  	<li><a href="<?php echo Utilities::generateUrl('products','view',array($val["prod_id"]))?>">

                     <!--  <img src="<?php echo Utilities::generateUrl('image','product_image',array($val['prod_id'],'THUMB'))?>" alt="<?php echo $val["prod_name"];?>"></a> -->

                     <img src="<?php echo $val["prod_image"]?>"
                     onerror='this.src="<?php echo Utilities::generateUrl('image','product_image',array($val["prod_id"],'MEDIUM'))?>"'
                     alt="<?php echo $val["prod_name"];?>"></a>
