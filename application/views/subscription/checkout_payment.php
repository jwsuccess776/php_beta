        ...
        <div class="checkout-page-data">
           <div id="paymenttab">
            <ul class="resp-tabs-list" id="payment_methods_tab">
              ...
              <!-- <li class="resp-tab" data-filter="999999" id="payfast_charge" onclick="alert();payfast_charge();alert();" >
    	        	<a href="<?php echo Utilities::generateUrl("subscription",'package_payment_tab',array($order_info["mporder_id"],'999999'));?>">
	            		<i><img src="https://www.payfast.co.za/storage/PayFast-logo.png" height="18"  alt=""/></i>
            			<span>Payfast </span>
            		</a>
            	</li>-->
