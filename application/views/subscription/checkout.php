...
$(document).ready(function(){
	...
	var payfast_data = '<div class="payment-table-cell"><p><strong>Pay using Payfast :</strong></p><br><p>Payfast  Description will go here</p><br><form method="post" action="/payfast_pay/package_charge/31" class="siteForm"><table width="100%"><tbody><tr><td colspan="2"><input type="submit" name="btn_submit" id="button-confirm" title="" value="CONFIRM PAYMENT"></td></tr></tbody></table><input type="hidden" name="order" value="31" title=""></form><div id="ajax_message"></div></div>';

	function payfast_charge()
	{
		$('#tabs-container').html(payfast_data);
			alert();
	} 
	/*$('#payfast_charge').click(function(){
