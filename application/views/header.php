...
<script defer id="mcjs">!function(c,h,i,m,p){m=c.createElement(h),p=c.getElementsByTagName(h)[0],m.defer=1,m.src=i,p.parentNode.insertBefore(m,p)}(document,"script","https://chimpstatic.com/mcjs-connected/js/users/8980749baf8fd3144217157b5/951824e05c3cde72477a94e67.js");</script>
...
<!-- Global site tag (gtag.js) - AdWords: 849203835 -->
<script defer src="https://www.googletagmanager.com/gtag/js?id=AW-849203835"></script>
<script defer>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-849203835');
</script>
</head>
...
$a = $link;
if (strpos($a, 'payment_success') !== false || strpos($a, 'package_payment_success') !== false) {
     if(isset($_SESSION['order_criteo'])){
      ...
      $json_array = json_decode($_SESSION['criteo_session']);
      
      $criteo_item_string = "[]";
      if(count($json_array)){
          $criteo_item_string = '[';
          foreach ($json_array as $key => $value) {
            $criteo_item_string .= '{id:"'.$value->id.'",price:'.$value->price.',quantity:'.$value->quantity.'},';
          }

          $criteo_item_string = rtrim($criteo_item_string, ',');
          $criteo_item_string.=']';
      }
?>
...
{ event: "trackTransaction", id: "<?php echo $order_criteo;?>", item: <?php echo $criteo_item_string?>}
...
C91.251,148.841,91.235,148.812,91.226,148.782z"/>
	...
	s-5.8-2.6-5.8-5.8C46.5,49,49.2,46.3,52.4,46.3z"/>
          ...
          <div class="right-side" id="list_ct_5">
            ...
            <a href="<?php echo Utilities::generateUrl('cart','checkout')?>" id="" class="" >
            <i class="svg-icn">
              <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="70px" height="70px" viewBox="0 0 70 70" enable-background="new 0 0 70 70" xml:space="preserve">
                <path fill-rule="evenodd" clip-rule="evenodd" fill="#ff3a59" d="M70.1,11.7h-7l-7,21H25.7l-7-23.3c0,0-2.8-9.2-7-9.3h-7
      ...
      <div class="top-head">
        <div class="fixed-container">
          ...
          <?php if (($is_buyer_logged) || ($is_front_user_logged == false) && (!$is_affiliate_logged)):?>	
            ...
            <!--<a href="javascript:void(0)" id="cart_summary" class="click_trigger">-->
            <a href="<?php echo Utilities::generateUrl('cart','checkout')?>" id="" class="" >
            <span id="cart-total"><strong><?php echo Utilities::getLabel('M_Cart')?></strong> <span class="count_cart_items"><?php echo $cart_items?></span> <?php echo Utilities::getLabel('M_items')?>  </span> </a> <!--<a class="click_trigger after-arrow"  id="cart_summary"  href="javascript:void(0)"></a>-->
             	 <ul id="list_cart_summary" class="dropdown-menu pull-right cart-drop">
                 	<?php echo $cart_summary?>
              	</ul>
            </div>
