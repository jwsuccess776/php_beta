            ...
            <div class="ft-section clearfix">
              ...
              <div class="f-cell first">
                ...
                <div class="f-logo">
                	...
                	<img class="lozad" data-src="<?php echo Utilities::generateUrl('image', 'footer_logo_graphic',array(Settings::getSetting("CONF_FOOTER_LOGO_GRAPHIC")), CONF_WEBROOT_URL)?>" alt="<?php echo Settings::getSetting("CONF_WEBSITE_NAME")?>"/>
...
<?php //echo '<div style="display:none"><pre>'; print_r($link); echo '</pre></div>'; ?>                   

            		<?php if($link['navlink_type']==0 && $link['navlink_caption']!='Featured Shops'): ?>
                    ...
                    <?php elseif($link['navlink_type']==0 && $link['navlink_caption']=='Featured Shops'): ?>

                    <li><a target="<?php echo $link['navlink_href_target']?>" href="<?=str_replace('{SITEROOT}', CONF_WEBROOT_URL, $link['navlink_html'])?>"><?php echo $link['navlink_caption']; ?></a></li>
...
<script defer src="<?php echo CONF_WEBROOT_URL?>js/common-function.js" type="text/javascript"></script>
