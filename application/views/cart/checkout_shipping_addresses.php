...
<form class="web_form">
		...
		<div class="address-bar shipping_addresses">
                ...
                <div class="address <?php echo (($address['ua_id']==$selected_address)?'selected':''); ?>">
                  ...
                  <?php echo ((strlen($address['ua_address1']) > 0)?$address['ua_address1']:'') .((strlen($address['ua_address2']) > 0)?'<br/>'.$address['ua_address2']:'') . ((strlen($address['city_name']) > 0)?'<br/>'.$address['city_name'] . ', ':'') . $address['ua_zip']; ?><br><?php echo $address['state_name']; ?>, <?php echo $address['country_name']; ?><br>
