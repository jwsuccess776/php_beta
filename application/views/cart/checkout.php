    ...
    <div id="main-area">
      <section id="content">
        ...
        <div class="checkout-content">
          ...
          <section id="billing-address" class="checkout-panel clearfix <?php if($billing_address_formatted){ echo 'done'; } ?> ">
            <div class="title-bar">
          ...
          <section id="shipping-address" class="checkout-panel clearfix <?php if($shipping_address_formatted){ echo 'done'; } ?> ">
              <div class="title-bar">
...
$(document).ready( 
    function(){ 
        ...
        if(!($('#billing-address .change-address').hasClass('hide')) && !($('#shipping-address .change-address').hasClass('hide'))){
...
function validateAddressForm(frm,v){
		...
		me.data('requestRunning', true);
				...
				//Implemented by jenerick
				if (json['success']==1){

                    //Auto select address here
                    var addressID = json['address_id'];
                    cart.short_billing_address_update(addressID);
                    $('#shipping-address .change-address').removeClass('hide');
