...
<ul>
  <li><span class="pull_left"><?php echo Utilities::getLabel('M_TOTAL_ITEMS')?> (<?php echo count($products);?>) </span><span class="pull_right"><strong><?php echo Utilities::displayMoneyFormat($cart_summary["cart_total"]); ?></strong> </span> </li>
