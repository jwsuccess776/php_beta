...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="cart-tbl">
    ...
    <tbody>
      ...
      <tr id="cart-row-<?php echo md5($product['key']); ?>">
        <td><span class="mobile-caption"><?php echo Utilities::getLabel('M_Product_Name')?></span>
            <div class="product-name">
               <a href="<?php echo Utilities::generateUrl('products','view',array($product["product_id"]))?>"><?php echo subStringByWords($product["name"],50)?></a>
...
<div class="total-bottom clearfix">
    <div class="total-side">
      <div class="btn-row">
          <a href="javascript:void(0);" id="cartContinue" class="btn primary-btn"> <?php echo Utilities::getLabel('M_Continue')?> </a>
      </div>
    </div>
</div>
