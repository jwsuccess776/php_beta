          ...
          <table class="cart-tbl" width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <thead>
              ...
              <tr>
                ...
                <th width="15%"><?php echo Utilities::getLabel('M_SELLER_INFORMATION')?></th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    ...
                    <?php echo Utilities::getLabel('L_Sold_By') ?>: <strong  class="blue-txt"><a href="<?php echo Utilities::generateUrl('shops', 'view',array($product['shop_id'])) ?>"><?php echo $product["seller_address"]["shop_name"]?></a> </strong> 
