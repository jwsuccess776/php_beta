...
<div class="left-panel gray-side" id="fixed__panel">
				<div class="boxRound">
				<input type="text" name="searchKeyword" id="searchKeyword" onkeydown="searchStore(event);" placeholder="Search this store" style="width:100%;padding-top:10px;padding-bottom:10px;padding-left:5px;font-weight:'bold';">
				</div>
            ...
            <div class="boxRound">
                <div class="boxTop"><a href="javascript:void(0)" class="openToggle toggleLink"></a>
                    <h4><?php echo Utilities::getLabel('L_PAYMENTS_ACCEPTED_BY') ?></h4>
                    <span style="text-transform:uppercase;font-weight:600;font-size:14px;color:#000;">"<?php echo $shop["shop_name"]; ?>"</span>
                    <br/>
                </div>
                <div class="box_Middle toggleWrap">
                    <div class="listscroll">
                        <ul class="labelList">
                            <li>
                                <label>                                     
                                    <img src="<?php echo CONF_WEBROOT_URL . 'images/icons8-ok-64.png' ?>" width="24px;" style="display:inline-block;"/>
                                    <span class="span2" style="display:inline-block;">SID</span>
                                </label>
                            </li>
                            <?php
                            if (!empty($custom_payment_option)) {
                                foreach ($custom_payment_option as $key => $val) {
                                    $image_path = empty($val['status']) ? 'images/icons8-delete-64.png' : 'images/icons8-ok-64.png';
                                    ?>
                                    <li>
                                        <label>                                     
                                            <img src="<?php echo CONF_WEBROOT_URL . $image_path ?>" width="24px;" style="display:inline-block;"/>
                                            <span class="span2" style="display:inline-block;"><?php echo ucfirst($val['name']); ?></span>
                                        </label>
                                    </li>
