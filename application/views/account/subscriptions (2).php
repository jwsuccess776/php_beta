				...
				<div class="tbl-listing">
					<table>
						...
						<tr>
							...
							<td class="cellitem">
<?php
		if($order['mporder_merchantpack_id']==1)
		{
?>
			<a target="_blank" href="../standard-commission-rates/cms/view/15">View Rates</a>
<?php			
		}else
		{
?>			<span class="cellcaption"><?=Utilities::getLabel('L_Commission')?></span><?=$order['mporder_merchantpack_commission'];?>%
<?php		}
?>
							</td>
