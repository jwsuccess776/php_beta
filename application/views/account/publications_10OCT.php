          ...
          <div class="tbl-listing">
            <table>
              ...
              <tr>
                ...
                <td>
                    <span class="cellcaption"><?php echo Utilities::getLabel('L_Sold')?></span> <?php echo $row["prod_sold_count"] ?>
                    <?php
                    $conf_view_count = Settings::getSetting("CONF_ENABLE_VIEW_COUNT");
                    if (!empty($conf_view_count)) {
                        ?>
                        <span style="color:red">(<?php echo empty($row["total_visit"]) ? '0' : $row["total_visit"] ?> views)</span>
                        <?php
                    }
                    ?>
                </td>
