        ...
        <div class="dashboard">
          ...
          <div class="data-side">
            ...
            <!--<h3>Products Setup</h3>-->
             <div class="box-head">
            	<h3><?php echo Utilities::getLabel('L_Shipping_Class_Setup')?> <a href="<?php echo Utilities::generateUrl('account', 'product_setup_info')?>" rel="fancy_popup_box"> <i class="svg-icn">
                                            ...
                                            <table id="tab_general">
                                                <tr>
                                                    <td width="25%">
                                                        ...
                                                        <? if (Settings::getSetting("CONF_PRODUCT_SKU_MANDATORY")){ ?><span class="spn_must_field">*</span><? } ?></td>
