                	...
                	<!--tab 1 start here-->
                                    ...
                                    <td>
                                       ...
                                       <!-- <input type="text" name="product_shipping[<?php /*echo $shipping_row; */?>][country_name]" value="<?php /*echo $shipping["pship_country"]!="-1"?$shipping["country_name"]:"&#8594;Everywhere else"*/?>" placeholder="<?php /*echo Utilities::getLabel('M_Shipping')*/?>" />
                                        ...
                                        <input <?php echo $disable; ?> type="text" name="product_shipping[<?php echo $shipping_row; ?>][state_name]" value="<?php echo $shipping["pship_state"]!="-1"?$shipping["state_name"]:"&#8594;Everywhere else"?>" placeholder="<?php echo Utilities::getLabel('M_Shipping')?>" required />

                                        <input type="hidden" name="product_shipping[<?php echo $shipping_row; ?>][state_id]" value="<?php echo $shipping["pship_state"]?>" />
                                    </td>
                                    <td>
                                        <span class="cellcaption"><?php echo Utilities::getLabel('M_Shipping_Company')?></span>
                                        <input type="text" name="product_shipping[<?php echo $shipping_row; ?>][company_name]" value="<?php echo $shipping["scompany_name"]?>" placeholder="<?php echo Utilities::getLabel('M_Company')?>" />
...
function addShipping() {
    ...
    html += '  <td><span class="cellcaption"><?php echo Utilities::getLabel('M_Ships_To')?></span><input type="text" name="product_shipping[' + shipping_row + '][state_name]" value="" placeholder="<?php echo Utilities::getLabel('M_Ships_To')?>" required /><input type="hidden" name="product_shipping[' + shipping_row + '][state_id]" value="" /></td>';
...
function shippingautocomplete(shipping_row) {
    ...
    $('input[name=\'product_shipping[' + shipping_row + '][state_name]\']').devbridgeAutocomplete({
        ...
        triggerSelectOnValidInput: true,
        onSelect: function (suggestion) {
            $('input[name=\'product_shipping[' + shipping_row + '][state_name]\']').val(suggestion.value);
...
function addShipping_new() {
        ...
        /////////////////////////////////////////////////////////
        html  = '<tr id="shipping-row' + shipping_row + '">';
        html += '  <td><input type="text" name="product_shipping[' + shipping_row + '][state_name]" value=" Everywhere Else" disabled /><input type="hidden" name="product_shipping[' + shipping_row + '][state_id]" value="-1" /></td>';
