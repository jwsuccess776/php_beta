      ...
      <div class="dashboard">
        ...
        <div class="data-side">
          ...
          <div class="box-head no-print">
            ...
            <div class="padding20 fr"> 
        
            	<a href="<?php echo Utilities::generateUrl('account', 'sales')?>" class="btn small"><?php echo Utilities::getLabel('L_My_Sales')?></a> 
            	
            	<a target="_blank" href="<?php echo Utilities::generateUrl('account', 'sales_print_order',array($order_detail['opr_id']))?>" class="btn small secondary-btn "><?php echo Utilities::getLabel('L_Print_Order')?></a>

            	<a href="<?php echo Utilities::generateUrl('account', 'send_message_to_buyer',array($order_detail['order_user_id'],$order_detail['opr_id'],$order_detail['order_invoice_number']))?>" class="btn small secondary-btn ">Message Buyer</a>
            ...
            <table class=" tbl-normal">
              <tbody>
                ...
                <tr>
                  ...
                  <? else: ?>
                  <td colspan="2"><span class="itemcaption"><?php echo Utilities::getLabel('L_Order_Total')?></span> <?php echo $currencyObj->format($order_detail["opr_net_charged"],$order_detail["order_currency_code"],$order_detail["order_currency_value"])?></td>
                  <td>
                      <?php if(!in_array($order_detail['orders_status_name'], ['Payment Pending', 'Cancelled'])) {?>

                      <span class="itemcaption"><?php echo Utilities::getLabel('L_Email') ?></span> <?php echo $order_detail['order_user_email']; ?> <br>
                      <span class="itemcaption"><?php echo Utilities::getLabel('L_Contact_Number') ?></span> <?php echo $order_detail['order_shipping_phone']; ?>
            ...
            <table class="tbl-normal">
              <tbody>
                ...
                <tr>
				  ...
				  <td><span class="cellcaption"><?php echo Utilities::getLabel('L_Product_Name')?></span>
				  
				   <a target="_blank" href="<?php echo Utilities::generateUrl(preg_replace('/[^A-Za-z0-9-]+/', '-', $order_detail["opr_name"]),'products',array('view',$order_detail["opr_product_id"]))?>"><?php echo $order_detail["opr_name"]?></a>
				   
				  <?php echo $customization_cost?>
