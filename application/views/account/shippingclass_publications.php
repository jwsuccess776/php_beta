            ...
            <table>
              ...
              <tr>
                ...
                <td>
                    ...
                    <?php
                    if(!empty($check_assion_product[$row['id']]))
                    {
                        $msg = Utilities::getLabel('L_msg_check_class_assion_product');
                    }
                    else
                    {
                        $msg = Utilities::getLabel('L_Are_you_sure_delete_class');
                    }
                    ?>
                
                <a onclick="return(confirm('<?php echo $msg;?>'));" href="<?php echo Utilities::generateUrl('account', 'remove_shipping_class', array($row['id']))?>" title="<?php echo Utilities::getLabel('L_Remove')?>" class="actions" >
		  ...
		  <?php else:?>    
	        	<div class="space-lft-right">
                	<div class="alert alert-info">
    	    			<?php echo Utilities::getLabel('L_You_do_not_have_listings_of_shipping_class')?>
		        	</div>
                </div>
          <?php endif;?>
        </div>
