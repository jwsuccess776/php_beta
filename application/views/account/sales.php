            ...
            <table>
              <tbody>
                ...
                <tr>
                  ...
                  <td><span class="cellcaption"><?php echo Utilities::getLabel('L_Action')?></span><a class="actions" href="<?php echo Utilities::generateUrl('account', 'sales_view_order', array($row['opr_id']))?>" title="<?php echo Utilities::getLabel('L_View_Order')?>"><img src="<?php echo CONF_WEBROOT_URL?>images/retina/view.svg" alt=""/></a> <a class="actions " href="<?php echo Utilities::generateUrl('account', ($row["orders_status_name"] == 'Payment Confirmed'?'seller_cancellation_request':'cancel_order') , array($row['opr_id']))?>" title="<?php echo Utilities::getLabel('L_Cancel_Order')?>"><img src="<?php echo CONF_WEBROOT_URL?>images/retina/close.svg" alt=""/></a></td>
                </tr>
                <?php endforeach;?>
              </tbody>
            </table>
