                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <div class="product-desc">
                          <ul>
                            ...
                            if ($val["orders_status_name"] == 'Payment Pending') {
                                ...
                                $expireDate;
                                ?>
                                <li><span><a href="#" class="timecounter" style="display:table-row-group;color:red"><?php echo $expireDate; ?></a></span>
                                    <span><img src="<?php echo CONF_WEBROOT_URL . 'images/icons8-about-20.png' ?>" width="24px;" style="display:inline-block;" title="The buyer has the displayed time to make payment before the order is cancelled.We suggest messaging the buyer to request payment"/>
                                    </span>
                                </li>
                                <?php
                            }
                      ...
                      <td width="18%"><div class="price"><?php echo $currencyObj->format($val["opr_net_charged"],$val["order_currency_code"],$val["order_currency_value"])?></div>
                        <a class="actions" href="<?php echo Utilities::generateUrl('account', 'sales_view_order', array($val['opr_id']))?>" title="<?php echo Utilities::getLabel('L_View_Order')?>"><img src="<?php echo CONF_WEBROOT_URL?>images/retina/view.svg" alt=""/></a> <a class="actions" href="<?php echo Utilities::generateUrl('account', ($val["orders_status_name"] == 'Payment Confirmed'?'seller_cancellation_request':'cancel_order') , array($val['opr_id']))?>" title="<?php echo Utilities::getLabel('L_Cancel_Order')?>"><img src="<?php echo CONF_WEBROOT_URL?>images/retina/close.svg" alt=""/></a></td>
                    </tr>
                    <?php endforeach; ?>
                  </tbody>
                </table>
