...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        loadStatesNew(document.getElementById('ua_country'), <?php echo intval($frmAddress->getField('ua_state')->value); ?>, document.getElementById('ua_state'), <?php echo intval($frmAddress->getField('ua_city')->value); ?>);
