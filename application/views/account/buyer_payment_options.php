...
<!--                                        <tr>
                                        ...
                                        <?php
                                            foreach ($custom_payment_option as $key => $val)
                                            {
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo $val['image_url']; ?>" width="100px">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        {
                                                            ?>
                                                            <a class="btn btn-success" href="<?= Utilities::generateUrl('account', 'buyer_payment_options') ?>?val=1&pay_option=<?php echo $key; ?>"> <i class="fa fa-user"></i> Active</a>
                                                            <?php
                                                        }
                                                        elseif ($val['status'] == '1')
                                                        {
                                                            ?>
                                                            <a class="btn btn-danger" href="<?= Utilities::generateUrl('account', 'buyer_payment_options') ?>?val=0&pay_option=<?php echo $key; ?>"> <i class="fa fa-user"></i> Inactive</a>
                                                            <?php
                                                        }
                                                        ?> 
                                                    </td>
