...
<li class="dashboard">
	<a href="<?php echo Utilities::generateUrl('account', 'buyer_rating')?>"> 
	<img style="background: #474747;
    width: 30px;
    height: 30px;
    display: block;
    margin: 0 auto;
    padding: 1px;" src="/images/retina/list.svg"> 
	
	<span>Buyer Rating</span> </a>
</li>
  ...
  <g>
    <g>
      ...
      <path d="M12.7,52.3l-1.4,1.4l1.3,1.3H4v-3H2v4c0,0.6,0.4,1,1,1h9.6l-1.3,1.3l1.4,1.4l3-3c0.4-0.4,0.4-1,0-1.4L12.7,52.3z"/>
              ...
              <li class="publications <?php if (($action=="publications") || ($action=="paused_publications") || ($action=="finalized_publications") || ($action=="product_form")) :?>active<?php endif;?>"><a href="<?php echo Utilities::generateUrl('account', 'publications')?>"> <i> 
	 ...
	 width="70px" height="70px" viewBox="0 0 70 70" enable-background="new 0 0 70 70" xml:space="preserve">
		 ...
		 M8.7,26.3h43.7v4.4H8.7V26.3z M8.7,39.4h43.7v4.4H8.7V39.4z M8.7,52.5h43.7v4.4H8.7V52.5z M8.7,52.5"/>
                ...
                <li class="publications <?php if (($action == "shipping_class") || ($action=='shippingclass_publications') || ($action == "shipping_class_form")) : ?>active<?php endif; ?>"><a href="<?php echo Utilities::generateUrl('account', 'shippingclass_publications') ?>">
               <!--<li class="publications <?php// if (($action=="shipping_class") || ($action=="shipping_class_form")) :?>active<?php //endif;?>"><a href="<?php// echo Utilities::generateUrl('account', 'shipping_class')?>">-->
                   <i> <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="70px" height="70px" viewBox="0 0 612 612" style="enable-background:new 0 0 612 612;" xml:space="preserve">
                    <g>
		                <path d="M226.764,375.35c-28.249,0-51.078,22.91-51.078,51.16c0,28.166,22.829,51.078,51.078,51.078s51.078-22.912,51.078-51.078    C277.841,398.26,255.013,375.35,226.764,375.35z M226.764,452.049c-14.125,0-25.54-11.498-25.54-25.541    c0-14.123,11.415-25.539,25.54-25.539c14.124,0,25.539,11.416,25.539,25.539C252.302,440.551,240.888,452.049,226.764,452.049z     M612,337.561v54.541c0,13.605-11.029,24.635-24.636,24.635h-26.36c-4.763-32.684-32.929-57.812-66.927-57.812    c-33.914,0-62.082,25.129-66.845,57.812H293.625c-4.763-32.684-32.93-57.812-66.845-57.812c-33.915,0-62.082,25.129-66.844,57.812    h-33.012c-13.606,0-24.635-11.029-24.635-24.635v-54.541H612L612,337.561z M494.143,375.35c-28.249,0-51.16,22.91-51.16,51.16    c0,28.166,22.912,51.078,51.16,51.078c28.166,0,51.077-22.912,51.077-51.078C545.22,398.26,522.309,375.35,494.143,375.35z     M494.143,452.049c-14.125,0-25.539-11.498-25.539-25.541c0-14.123,11.414-25.539,25.539-25.539    c14.042,0,25.539,11.416,25.539,25.539C519.682,440.551,508.185,452.049,494.143,452.049z M602.293,282.637l-96.817-95.751    c-6.159-6.077-14.453-9.526-23.076-9.526h-48.86v-18.313c0-13.631-11.004-24.635-24.635-24.635H126.907    c-13.55,0-24.635,11.005-24.635,24.635v3.86L2.3,174.429l177.146,23.068L0,215.323l178.814,25.423L0,256.25l102.278,19.29    l-0.007,48.403h509.712v-17.985C611.983,297.171,608.452,288.796,602.293,282.637z M560.084,285.839h-93.697    c-2.135,0-3.86-1.724-3.86-3.859v-72.347c0-2.135,1.725-3.86,3.86-3.86h17.82c0.985,0,1.971,0.411,2.71,1.068l75.796,72.347    C565.257,281.569,563.532,285.839,560.084,285.839z" fill="#FFDA44"/>
	                </g>
                    </svg></i>
                    <span>Shipping Class</span> </a></li>
               
               <!-- payment options -->
               
<li class="publications <?php if (($action=="buyer_payment_options")) :?>active<?php endif;?>"><a href="<?php echo Utilities::generateUrl('account', 'buyer_payment_options')?>"> 
...
<g>
	<g>
		...
		<g>
			<path d="M38.642,37.921c-0.563-0.397-1.51-0.78-2.833-1.141v8.369c1.816-0.084,3.066-0.746,3.754-1.987
				c0.358-0.639,0.541-1.384,0.541-2.212C40.105,39.622,39.617,38.616,38.642,37.921z"/>
			<path d="M31.302,27.296c-0.593,0.794-0.89,1.625-0.89,2.497c0,1.049,0.35,1.874,1.049,2.467c0.703,0.598,1.646,1.012,2.835,1.24
				v-7.481C32.897,26.075,31.897,26.495,31.302,27.296z"/>
			<path d="M35.037,17.762c-10.105,0-18.296,8.193-18.296,18.293c0,10.105,8.191,18.299,18.296,18.299
               ...
               </i> <span>Payment Options</span> </a></li>
	 ...
	 width="70px" height="70px" viewBox="0 0 70 70" enable-background="new 0 0 70 70" xml:space="preserve">
		...
		L38.4,55.2z M49.2,47.4l1.5,1.5l-6.2,6.2L43,53.6L49.2,47.4z M49.2,47.4"/>
                ...
                <li class="shop <?php if ($action=="shop"):?>active<?php endif;?>"><a href="<?php echo Utilities::generateUrl('account', 'shopLayouts')?>"> <i> <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                                                                                                                              width="70px" height="70px" viewBox="0 0 70 70" enable-background="new 0 0 70 70" xml:space="preserve">
                <g>
                    <path fill="#474747" d="M0,28.5c0,4.1,2.8,7.5,6.6,8.5v28.8H2.2c-1.2,0-2.2,1-2.2,2.2s1,2.2,2.2,2.2h65.7c1.2,0,2.2-1,2.2-2.2
		s-1-2.2-2.2-2.2h-4.4V36.9c3.8-1,6.6-4.4,6.6-8.5v-2.2H0V28.5z M43.8,37.2c4.8,0,8.8-3.9,8.8-8.8c0,4.1,2.8,7.5,6.6,8.5v28.8H26.3
		...
		L38.4,55.2z M49.2,47.4l1.5,1.5l-6.2,6.2L43,53.6L49.2,47.4z M49.2,47.4"/>
                ...
                </svg></i> <span><?php echo Utilities::getLabel('M_Shop_Layouts')?></span> </a></li>
