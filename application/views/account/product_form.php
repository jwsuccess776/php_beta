...
<?php
$attributes=$data["product_attributes"]; $shipping_rates=$data["product_shipping_rates"];
 $discount_rates=$data["product_discounts"]; $special_rates=$data["product_specials"];     $product_options=$data["product_options"]; $option_values=$data["option_values"];   $downloads=$data["product_downloads"]; ?>
            ...
            <div>
                	<!--tab 1 start here-->
    		                        <div id="tabs_1" class="tabs_content border_cover">
        	                                ...
        	                                <td width="25%"><label><?php echo Utilities::getLabel('M_Product_Category')?></label> <span class="spn_must_field">*</span> </td>
            	                            <td><?php echo Utilities::stripRequiredStar($frm->getFieldHTML('prod_category[]'));?></td>
                	                        </tr>
                                            <td width="25%"><label><?php echo Utilities::getLabel('M_Model')?></label> </td>
                                            ...
                                            <?php } ?><?php if (Settings::getSetting("CONF_SHIPSTATION_API_STATUS")):?><tr class="">
                                            ...
                                            <!--///////////////////////////-->
                                            <tr class="type_required shipping_required">
                                                <td width="25%"><label><?php echo Utilities::getLabel('M_CLASS_NAME')?></label></td>
                                                <td><?php echo $frm->getFieldHTML('class_name');?>
                                                <br><small>Add multiple products to the same shipping class to combine shipping costs.</small>
                                                </td>
                                            </tr>
                                            <!--///////////////////////////-->
                                    ...
                                    <td>
                                       ...
                                       <!-- <input type="text" name="product_shipping[<?php /*echo $shipping_row; */?>][country_name]" value="<?php /*echo $shipping["pship_country"]!="-1"?$shipping["country_name"]:"&#8594;Everywhere else"*/?>" placeholder="<?php /*echo Utilities::getLabel('M_Shipping')*/?>" />
                                        ...
                                        ?>
                                        <?php $disable = ''; if($shipping["pship_state"] == '-1' && $shipping['pship_city']=='-1'){ $disable = 'disabled'; } ?>
                                        ...
                                        <input type="hidden" name="product_shipping[<?php echo $shipping_row; ?>][state_id]" value="<?php echo $process_state_id//$shipping["pship_state"]?>" />
                                    ...
                                    <td>
                                        ...
                                        <input type="text" style="width:175px;" name="product_shipping[<?php echo $shipping_row; ?>][company_name]" value="<?php echo $shipping["scompany_name"]?>" placeholder="<?php echo Utilities::getLabel('M_Company')?>" />
                                         <input type="hidden" name="product_shipping[<?php echo $shipping_row; ?>][company_id]" value="<?php echo $shipping["scompany_id"]?>" />
                                    </td>
                                    <td>
                                    <span class="cellcaption"><?php echo Utilities::getLabel('M_Processing_Time')?></span>
                                    <input type="text" style="width:175px;" name="product_shipping[<?php echo $shipping_row; ?>][processing_time]" value="<?php echo $shipping["sduration_label"]?>" placeholder="<?php echo Utilities::getLabel('M_Processing_Time')?>" /><input type="hidden" name="product_shipping[<?php echo $shipping_row; ?>][processing_time_id]" value="<?php echo $shipping["sduration_id"]?>" /></td>
                                    <td>
                                    <span class="cellcaption"><?php echo Utilities::getLabel('M_Cost')?> [<?php echo CONF_CURRENCY_SYMBOL?>]</span>
                                    <input type="text" style="width:95px;" name="product_shipping[<?php echo $shipping_row; ?>][cost]" value="<?php echo $shipping["pship_charges"]?>" placeholder="<?php echo Utilities::getLabel('M_Cost')?>" /></td>
                                    <td>
                                    <span class="cellcaption"><?php echo Utilities::getLabel('M_Each_Additional_Item')?> [<?php echo CONF_CURRENCY_SYMBOL?>]</span>
                                    <input type="text" style="width:95px;" name="product_shipping[<?php echo $shipping_row; ?>][additional_cost]" value="<?php echo $shipping["pship_additional_charges"]?>" placeholder="<?php echo Utilities::getLabel('M_Each_Additional_Item')?>" /></td>
                                    <td>
                                        <?php if($shipping_row > 0){ ?>
...
$( document ).ready(function() {
    ...
    if(elem.value=='0')
    {
		...
		//elem.find('select option').css('background-color', '#ccc');
...
$("#prod_ship_free").trigger("change");
       ...
       <?php }
?>
$("#class_name").bind("change", function() {
    console.log('class_name');
    var elem=$(".shipping_required");
    if ($(this).val()=='') {
        elem.find('input').attr('disabled', false);
        //elem.find('select').attr('disabled', false);
        elem.find("td,th").css('color','');
        elem.find('input').css('background-color', '');
        //elem.find('select').css('background-color', '');
    ...
    else
    {
        ...
        elem.find("td,th").css('color','#ccc');
        elem.find('input').css('background-color', '#ccc');
        //elem.find('select').css('background-color', '#ccc');
        elem.find('button').addClass('disabled');
    }
    
            $("input[name='product_shipping\\[0][state_name]']").attr('disabled',true); 
...
function check_class_name()
{
    var elem=$(".shipping_required");
    if ($('#class_name').val()=='') {
//        elem.find('input').removeClass('disabled');
//        //elem.find('select').attr('disabled', false);
//        elem.find("td,th").css('color','');
//        elem.find('input').css('background-color', '');
//        //elem.find('select').css('background-color', '');
//        elem.find('button').removeClass('disabled');
        ...
        elem.closest('tr').find("input,button").attr('disabled',false);
    }
    else
    {
//        elem.find('input').addClass('disabled');
//        //elem.find('select').attr('disabled', true);
//        elem.find("td,th").css('color','#ccc');
//        elem.find('input').css('background-color', '#ccc');
//        //elem.find('select').css('background-color', '#ccc');
...
function addShipping() {
	...
	/*html += '  <td><span class="cellcaption">  //echo Utilities::getLabel('M_Ships_To')?></span><input type="text" name="product_shipping[' + shipping_row + '][country_name]" value="" placeholder="  //echo Utilities::getLabel('M_Ships_To')?>" /><input type="hidden" name="product_shipping[' + shipping_row + '][country_id]" value="" /></td>';*/
...
function addShipping_new() {
        ...
        html += '  <td><span class="cellcaption"><?php echo Utilities::getLabel('M_Cost')?> [<?php echo CONF_CURRENCY_SYMBOL?>]</span>';
        html += '<input type="text" style="width:95px;" name="product_shipping[' + shipping_row + '][cost]" value="" placeholder="<?php echo Utilities::getLabel('M_Cost')?>" required />';
        html += '</td>';
        html += '<td><span class="cellcaption"><?php echo Utilities::getLabel('M_Each_Additional_Item')?> [<?php echo CONF_CURRENCY_SYMBOL?>]</span>';
        html += '<input type="text" style="width:95px;" name="product_shipping[' + shipping_row + '][additional_cost]" value="" placeholder="<?php echo Utilities::getLabel('M_Each_Additional_Item')?>" required />';
        html += '</td>';
        html += '</tr>';
