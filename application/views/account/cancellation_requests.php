            ...
            <table>
              ...
              <tr>
                                      ...
                                      <td><span class="cellcaption"><?php echo Utilities::getLabel('L_Request_Details')?></span>
										<?php if($row['cancellation_request_user_id']!=$row['vendor_id']) ?>
                                      ...
                                      <td><span class="cellcaption"><?php echo Utilities::getLabel('L_Status')?></span>
										...
										<?php 
											...
											if($row["cancellation_charge_type"] != "" && $row['cancellation_request_user_id']==$row['vendor_id'])
											{
												if($row["cancellation_charge_type"]=="charged_for_processing_fee_and_commission")
												{
													echo "<br><strong>Comment: </strong> " . "Charged commission and payment processing fee";
												}
												else if($row["cancellation_charge_type"]=="chargeed_for_processing_fee_only")
												{
													echo "<br><strong>Comment: </strong> " . "Charged payment processing fee";
												}
													
											}
											else if($row["cancellation_request_decline_reason"] != "" && $row['cancellation_request_user_id']==$row['vendor_id'])
											{
												echo "<br><strong>Comment: </strong> " . $row["	cancellation_request_decline_reason"];
											}
