<?php
    ...
    class Orders extends Model
    {
        ...
        public function addChildOrderHistory($child_order_id, $opr_order_status_id, $comment = '', $notify = false, $tracking_number, $release_payments = 0,$cancellation_request=null)
        {
            $p = new Products();
            ...
            if ($child_order_info)
            {
                ...
                if (in_array($opr_order_status_id, (array) Settings::getSetting("CONF_BUYER_ORDER_STATUS")) && $notify)
                {
					...
					{
						$emailNotificationObj = new Emailnotifications();
						$emailNotificationObj->Seller_Cancellation_Approved_Order_Status_Update_Buyer($comment_id,$cancellation_request);
					}
					else
					{
						$emailNotificationObj = new Emailnotifications();
