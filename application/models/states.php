...
class States extends Model {
    ...
    function getNewAsscociativeArray($country_id = 0) {
        $srch = new SearchBase('tbl_states', 's');

        $srch->joinTable('tbl_countries', 'INNER JOIN', 's.country_id=tc.country_id and country_delete=0', 'tc');
        $srch->joinTable('tbl_zones', 'INNER JOIN', 's.zone_id=tz.zone_id and zone_delete=0', 'tz');
        $srch->addCondition('s.state_delete', '=', 0);
